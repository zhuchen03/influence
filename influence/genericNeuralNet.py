...
class GenericNeuralNet(object):
    ...
    def get_influence_on_train_loss(self, test_indices, train_idx,
                                    approx_type='cg', approx_params=None, force_refresh=True, test_description=None,
                                    loss_type='normal_loss',
        ...
        test_grad_loss_no_reg_val = self.get_train_grad_loss_no_reg_val(test_indices, loss_type=loss_type)
