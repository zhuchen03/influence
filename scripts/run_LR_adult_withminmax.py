...
# res_dir = './LR_influence/adult_minmin_rho1'
# minmax_idx = np.load('/scratch0/GoGradients/code/exp/ploting/exp2/min.npy').argsort()[::-1][:30]
# res_dir = './LR_influence/adult_maxhingepts_2'
# minmax_idx = np.load('/scratch0/GoGradients/code/svm_figures/train_most_confusing_idxes_C1.npy')[:30]
res_dir = './LR_influence/adult_minmin_rho1'
minmax_idx = np.load('/scratch0/GoGradients/code/exp/ploting/exp2/min.npy').argsort()[:30]# finding minmin with smallest p
